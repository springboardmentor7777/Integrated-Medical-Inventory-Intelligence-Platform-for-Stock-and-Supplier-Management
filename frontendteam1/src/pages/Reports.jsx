...
function Reports() {
  ...
  // Convert frontend category names to backend category names
  ...
  // Build report URL with selected filters
  const getReportUrl = () => {
    ...
    return `http://localhost:8080/api/reports/medicines?${params.toString()}`;
  };

  // Build Excel report URL with selected filters
  const getExcelReportUrl = () => {
    ...
    return `http://localhost:8080/api/reports/medicines/excel?${params.toString()}`;
  };
            ...
            <div className="flex flex-col justify-between gap-5 md:flex-row md:items-center">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <button
                    ...
                    className="rounded-xl border border-purple-200 bg-purple-50 px-5 py-3 text-sm font-semibold text-purple-700 transition hover:bg-purple-100 disabled:cursor-not-allowed disabled:opacity-60"
                >
                ...
                <button
                    ...
                    disabled={downloading}
                    className="rounded-xl bg-purple-700 px-5 py-3 text-sm font-semibold text-white transition hover:bg-purple-800 disabled:cursor-not-allowed disabled:opacity-60"
                >
