...
import { Building2, CheckCircle2, Edit3, Plus, Search, Star, Trash2, Truck, X } from 'lucide-react';
  ...
  return (
    <div className="page-wrap">
      <div className="page-header">
        <div><p className="eyebrow">Backend 2 · Supplier management</p><h1>Suppliers</h1><p>Maintain verified medical suppliers, contact details, lead time, rating, and operational status.</p></div>
      ...
      <div className="metric-grid">
        ...
        <MetricCard title="Active Suppliers" value={active} icon={CheckCircle2} tone="emerald" subtitle={`${items.length - active} inactive`} />
            ...
            <tbody>
              {loading ? <tr><td colSpan="7" className="empty-cell">Loading suppliers...</td></tr> : filtered.length === 0 ? (
                ...
                <tr key={s.id}>
                  ...
                  <td><span className="rating-cell"><Star size={13} /> {s.rating ?? '—'}</span></td>
